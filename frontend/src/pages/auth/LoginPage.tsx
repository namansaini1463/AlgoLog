      ...
      <div className="w-full max-w-md rounded-2xl bg-white p-6 sm:p-8 shadow-xl border border-gray-200 dark:bg-surface-dark dark:border-gray-800">
        ...
        <div className="space-y-3">
          <Button
            ...
            className="w-full bg-white text-gray-700 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 shadow-sm"
          >
