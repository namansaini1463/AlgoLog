...
export default function AdminDashboardPage() {
  ...
  return (
    <div>
      <h1 className="mb-6 text-2xl font-bold text-gray-900 dark:text-gray-100">Admin Analytics</h1>
      ...
      {analytics?.topTopics && analytics.topTopics.length > 0 && (
        <Card>
          <h3 className="mb-3 text-sm font-semibold text-gray-700 dark:text-gray-300">Top Topics in Bank</h3>
